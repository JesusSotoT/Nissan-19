...
$id = intval($_GET['id']);
$sql = mysqli_query($conn, "SELECT * FROM tagm_participante  WHERE clave ='$id'");
                ...
                <div class="row row-space">
                    <div class="col-2">
                        <div class="input-group-desc">
                            <input class="input--style-5" type="text" name="first_name" value="<?php echo $row['nombre'];  ?>">
                            <label class="label--desc">Nombre(s)</label>
                        </div>
                    </div>
                    <div class="col-2">
                        <div class="input-group-desc">
                            <input class="input--style-5" type="text" name="last_name" value="<?php echo $row['apellido_p'];  ?>">
        ...
        <div class="form-row m-b-55">
            ...
            <div class="value">
                <div class="row row-space">
                    <div class="col-2">
                        <div class="input-group-desc">
                            <input class="input--style-5" type="text" name="last_name" value="<?php echo $row['apellido_m'];  ?>">
...
$query2 = $conn -> query ("SELECT a.id , b.pais , a.pais FROM paises a LEFT JOIN tagm_participante b on a.id = b.pais WHERE b.clave = '$id_participante'");
...
echo '<option value="'.$valores1[id].'" selected>'.$valores1[pais].'</option>';
}
?>
                        </select>
...
<!-- GENERO FORM FIN -->
        ...
        <div class="form-row">
            ...
            <div class="value">
                <div class="input-group" id="datepicker">
                    <input class="input--style-5 datepicker" type="text" value="<?php echo $row['fecha_nacimiento'];  ?>" >
                </div>
            </div>
        </div>
        ...
        <div class="form-row ">
            ...
            <div class="value">
                  <div class="col-2">
                        <div class="input-group">
                            <input class="input--style-5" type="number" name="area_code" value="<?php echo $row['estatura'];  ?>">
...
<?php
include "conexion.php";
$query = $conn -> query ("SELECT a.id , b.talla, a.talla FROM tagm_tallas a LEFT JOIN tagm_participante b on b.talla = a.id WHERE b.clave = '$id_participante'");
?> 
...
echo '<option value="'.$valores[id].'" selected>'.$valores[talla].'</option>';
}
?>
                        </select>
                        <div class="select-dropdown"></div>
...
?>
        ...
        <div style="align-content: flex-end;">
            <a class="btn btn--radius-2 btn--red" href="home2admin.php">Cancelar</a>
        </div>
    </div>
    <!-- Jquery JS-->
    <script>
