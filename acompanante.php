...
<head>
    ...
    <!-- Title Page-->
    <title>Nissan 2019 - Registro Acompanante</title>
    <!-- Icons font CSS-->
        ...
        <div class="wrapper wrapper--w790">
            <div class="card card-5">
                <div class="card-heading">
                    <h2 class="title">Registro Acompañante | Nissan 2019 </h2>
                     <h3 class="title">Pariticpante | Participante </h3>
                </div>
                <div class="card-body">
                    <form method="POST">
...
while ($valores = mysqli_fetch_array($query)) {
  ...
  echo '<option value="'.$valores[id].'">'.$valores[tipo_sangre].'</option>';
                        ...
                        <div>
                            <button class="btn btn--radius-2 btn--red" type="submit">Finalizar</button>
                        </div>
                    </form>
                </div>
            </div>
