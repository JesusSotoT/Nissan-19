           ...
           <nav class="navbar navbar-transparent navbar-absolute">
            ...
            <div class="content">
                ...
                <div class="row">
                  ...
                  $query =  "SELECT clave FROM tagm_participante where pais = 1" ;
                    ...
                    <div class="col-md-4 ml-auto mr-auto">
                        <div class="card card-stats">
                            ...
                            <div class="card-content">
                                                                <?php
                                    include "../conexion.php";
                  $query =  "SELECT asistencia FROM tagm_participante WHERE asistencia = 1 and pais = 1" ;
                  $result = $conn->query($query);
                  $row_cnt = $result->num_rows;
                                ?>
                    ...
                    <div class="col-md-4 ml-auto mr-auto">
                        <div class="card card-stats">
                            ...
                            <div class="card-content">
                                    <?php
                                    include "../conexion.php";
                  $query =  "SELECT asistencia FROM tagm_participante WHERE asistencia = 0 and pais = 1" ;
                  $result = $conn->query($query);
                  $row_cnt = $result->num_rows;
                                ?>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table" id="sin_asistencia">
                                            ...
                                            <tbody>
                                                <?php
                                include "../conexion.php";
                  $query =  "SELECT a.clave , a.nombre , a.apellido_p , a.apellido_m, a.fecha_nacimiento , a.habitacion_hotel,a.asistencia, d.nombre as nombre_acompanante , d.apellido_p as acom_ape FROM tagm_participante a left join tagm_acompanante d on d.clave_p = a.clave WHERE asistencia = 0 and pais = 1" ;
                  $result = $conn->query($query);
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table" id="sin_asistencia">
                                            ...
                                            <tbody>
                                                <?php
                                include "../conexion.php";
                  $query =  "SELECT a.clave , a.nombre , a.apellido_p , a.apellido_m, a.fecha_nacimiento , a.habitacion_hotel,a.asistencia, d.nombre as nombre_acompanante , d.apellido_p as acom_ape FROM tagm_participante a left join tagm_acompanante d on d.clave_p = a.clave WHERE asistencia = 1 and pais = 1" ;
                  $result = $conn->query($query);
                while ($row = $result->fetch_array())
                  {
                  ?>
