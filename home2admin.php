        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="row">
                  ...
                  $query =  "SELECT clave FROM tagm_participante" ;
                    ...
                    <div class="col-md-4 ml-auto mr-auto">
                        <div class="card card-stats">
                            ...
                            <div class="card-content">
                                                                <?php
                                    include "conexion.php";
                  $query =  "SELECT asistencia FROM tagm_participante WHERE asistencia = 1" ;
                  $result = $conn->query($query);
                  $row_cnt = $result->num_rows;
                                ?>
                    ...
                    <div class="col-md-4 ml-auto mr-auto">
                        <div class="card card-stats">
                            ...
                            <div class="card-content">
                                    <?php
                                    include "conexion.php";
                  $query =  "SELECT asistencia FROM tagm_participante WHERE asistencia = 0" ;
                  $result = $conn->query($query);
                  $row_cnt = $result->num_rows;
                                ?>
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table" id="sin_asistencia">
                                            <thead class="title" style="font-size: 12px;">
                                                ...
                                                <th class="text-center">Estatura<br> (cm)</th>
                                            ...
                                            <tbody>
                                                <?php
                                include "conexion.php";
                  $query =  "SELECT a.clave , a.nombre , a.apellido_p , a.apellido_m, a.fecha_nacimiento, a.estatura ,b.talla , c.tipo_sangre , a.habitacion_hotel,a.asistencia, d.nombre as nombre_acompanante , d.apellido_p as acom_ape FROM tagm_participante a LEFT JOIN tagm_tallas b on b.id = a.talla LEFT JOIN tagm_tipos_sangre c on c.id = a.tipo_sangre left join tagm_acompanante d on d.clave_p = a.clave WHERE asistencia = 0" ;
                  $result = $conn->query($query);
...
$fecha = str_replace("/","-",$fecha1);
    ...
    $edad = $hoy - $fecha; 
    echo $edad; ?></td> 
<td class="text-center"><?php echo $row['estatura'] ?></td> 
<td class="text-center"><?php echo $row['talla'] ?></td>  
<td class="text-center"><?php echo $row['tipo_sangre'] ?></td>  
                       ...
                       <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    ...
                                    <div class="table-responsive">
                                    <table class="table" id="con_asistencia">
                                            <thead class="title" style="font-size: 12px;">
                                                <th class="text-center">Clave</th>
                                                <th class="text-center">Nombre</th>
                                                <th class="text-center">Apellido Paterno</th>
                                            ...
                                            <tbody>
                                                <?php
                                include "conexion.php";
                  $query =  "SELECT a.clave , a.nombre , a.apellido_p , a.apellido_m, a.fecha_nacimiento, a.estatura ,b.talla , c.tipo_sangre , a.habitacion_hotel,a.asistencia, d.nombre as nombre_acompanante , d.apellido_p as acom_ape FROM tagm_participante a LEFT JOIN tagm_tallas b on b.id = a.talla LEFT JOIN tagm_tipos_sangre c on c.id = a.tipo_sangre left join tagm_acompanante d on d.clave_p = a.clave WHERE asistencia = 1" ;
                  $result = $conn->query($query);
                while ($row = $result->fetch_array())
                  {
                  ?>
